...
const StyledWrapper = styled.div<StyledWrapperProps>`
  .form {
    --input-text-color: #000; /* 设置输入框文本颜色为黑色 */
    --input-bg-color: rgb(237, 242, 250);
  ...
  .fancy-bg {
    ...
    width: 100%;
    inset: 0;
    background: var(--input-bg-color); /* 背景颜色设置为灰色 */
    border-radius: 30px;
    height: 100%;
    z-index: -1;
    pointer-events: none;
  ...
  /* styling of input */
  .input {
    color: var(--input-text-color); /* 文本颜色设置为黑色 */
    width: 100%;
  ...
  .input::placeholder {
    color: var(--text-color); /* 保持原占位符颜色不变 */
  }
